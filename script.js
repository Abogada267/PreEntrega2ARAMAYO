window.onload = function window.onload = function() {
  ...
  let url =
    "https://link.mercadopago.com.ar/abogadamalvinaramayo" +
    "?preference-id=XXXXXXXXX" +
    "&total=" +
    precioFinal +
    "&installments=" +
    cuotas;
...
function ingreso() {
  ...
  if (edad >= 18) {
    ...
    if (
      confirm(
        'Hola, estás por ingresar a la página de la Dra. Aramayo sobre presupuestos. Si deseas ver los servicios que ofrece, haz clic en "Aceptar"; en caso contrario, en "Cancelar"'
      )
    ) {
